...
<div class="text-center">
        % newPrevString =  "http://localhost:8080/resultsLoggenIn/" + str(previousPage)
        <a href={{newPrevString}}><button id="previous" type="button" class="btn">Previous</button></a>
</div>



<div class="text-center">
% newString =  "http://localhost:8080/resultsLoggenIn/" + str(nextPage)
<a href= {{newString}}><button id="next" type="button" class="btn">Next</button></a>
</div>
