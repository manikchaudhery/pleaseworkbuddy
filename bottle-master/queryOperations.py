...
def getDocIDsDict(query, word_to_wordID, wordID_to_docIDs, docID_to_pageRank):
	...
	pageRanks = {}
	print('doc id to page rank', docID_to_pageRank)
	print("Doc IDS are: ", doc_IDs)
	for docID in doc_IDs:

		if docID in docID_to_pageRank:
...
def get_sorted_descriptions(orderedDocIds, descrByQuery):
	...
	print('description by query', descrByQuery)

	if descrByQuery is None:
		return ['No Description Available']

	print('ordered doc', orderedDocIds)
